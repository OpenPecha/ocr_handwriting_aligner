...
if __name__ == "__main__":
    # Define directories for landscape and portrait PDFs
    pdf_dirs = Path('/Users/tenzinchoedon/Downloads/scanned_images/འཁྱུག་ཡིག་གཤེར་དཔར།(landscape)')
    
    output_dirs = Path('/Users/tenzinchoedon/Downloads/scanned_images/ocr_images/landscape'),
    
    
    for pdf_dir, output_dir in zip(pdf_dirs, output_dirs):
