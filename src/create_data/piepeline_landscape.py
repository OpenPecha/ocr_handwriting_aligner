...
def pipeline(pdf_file_path:Path, transcript_file_path:Path, image_orientation:str, output_csv_path:Path=Path("line_image_mapping-landscape-P000012_v001_00001-00500.csv")):
    ...
    images_output = Path("pdf_to_images_output-landscape-P000012_v001_00001-00500")
    line_image_dir = Path("cropped_line_images-landscape-P000012_v001_00001-00500")
    line_image_label_dir = Path("cropped_line_images_label-landscape-P000012_v001_00001-00500") 
...
if __name__ == "__main__":
    pdf_file_path = Path("/Users/tenzinchoedon/Downloads/scanned_images/འཁྱུག་ཡིག་གཤེར་དཔར།(landscape)/P000012_v001_00001 - 00500.pdf")
    transcript_file_path = Path("/Users/tenzinchoedon/Downloads/scanned_images/transcript_csv/landscape/P000012_v001.csv")
