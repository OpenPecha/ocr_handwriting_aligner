...
def pipeline(images_path: List[Path], transcript_file_path:Path, output_csv_path:Path=Path("line_image_mapping.csv")):
...
if __name__ == "__main__":
    ...
    acceptable_images = pipeline(images_path, transcript_file_path)
